...
const Whyus = () => {
  ...
  return (
    <>
      <div id="service" className="w-full flex flex-col py-5 px-5 md:px-10 md:h-screen justify-between space-y-5 md:mb-20">
        ...
        <div className="flex space-y-3 flex-col md:flex-row justify-between">
          <div className="md:w-1/2">
            <h1 className="text-2xl md:text-4xl md:text-left text-center">Distribution built for e-commerce,
            at every scale</h1>
          </div>
          <div className="md:w-1/2">
            <p className="text-[#434343] text-xs md:text-[15px] text-center md:text-right">
